...
INSERT INTO l_bp_type_log VALUES ('PTO', 'PTO', '');
...
INSERT INTO l_classe_dict VALUES ('A', 'CLASSE A', '');
INSERT INTO l_classe_dict VALUES ('AP', 'CLASSE A PLANIMETRIQUE', 'Classe A en XY et precision degradee en Z');
INSERT INTO l_classe_dict VALUES ('B', 'CLASSE B', '');
INSERT INTO l_classe_dict VALUES ('C', 'CLASSE C', '');
INSERT INTO l_classe_dict VALUES ('NC', 'NON CONCERNE', '');
...
INSERT INTO l_doc_type VALUES ('DBL', 'DOSSIER DE RELEVE BOÎTES AUX LETTRES', '');
...
INSERT INTO l_doc_type VALUES ('DIM', 'DOSSIER IMMEUBLE ET/OU PLANS DE DETAILS INTRA-SITES (SITE CLIENT, SITE TECHNIQUE…)', '');
INSERT INTO l_doc_type VALUES ('DIP', 'DOSSIER D IMPLANTATION (SRO, NRO, BPI…)', '');
INSERT INTO l_doc_type VALUES ('SOP', 'SYNOPTIQUE OPTIQUE', '');
INSERT INTO l_doc_type VALUES ('SBP', 'PLAN DE BOÎTE, OU AUTRE ELEMENT DE BRANCHEMENT PASSIF', '');
...
INSERT INTO l_doc_type VALUES ('RCB', 'PV DE RECEPTION CABLAGE', '');
INSERT INTO l_doc_type VALUES ('ROP', 'PV DE RECEPTION RACCORDEMENT', '');
...
INSERT INTO l_statut VALUES ('PRE', 'ETUDE PRELIMINAIRE', 'Resultat de l etude preliminaire, au sens du decret d application de la loi MOP (n°93-1268 du 29 novembre 1993) : premiere etude de faisabilite pour la construction d ouvrages neufs');
INSERT INTO l_statut VALUES ('DIA', 'ETUDE DE DIAGNOSTIC', 'Resultat de l etude de diagnostic, au sens du decret d application de la loi MOP (n°93-1268 du 29 novembre 1993) : pour une operation de reutilisation ou de rehabilitation d un ouvrage existant, etat des lieux, analyse technique, etudes complementaires');
INSERT INTO l_statut VALUES ('AVP', 'AVANT-PROJET', 'Resultat de l etude d avant-Projet, au sens du decret d application de la loi MOP (n°93-1268 du 29 novembre 1993) : confirmation de la faisabilite, premiere implantation de l ouvrage, autorisations administratives');
INSERT INTO l_statut VALUES ('PRO', 'PROJET', 'Resultat de l etude de projet, au sens du decret d application de la loi MOP (n°93-1268 du 29 novembre 1993) : precise les choix techniques, fixe l implantation topographique, les caracteristiques et le dimensionnement');
INSERT INTO l_statut VALUES ('ACT', 'PASSATION DES MARCHES DE TRAVAUX', 'Resultat de la mission d assistance a la passation des marches de travaux, au sens du decret d application de la loi MOP (n°93-1268 du 29 novembre 1993) : mise a jour eventuelle de l etude projet ');
INSERT INTO l_statut VALUES ('EXE', 'ETUDE D EXECUTION', 'Resultat de l etude d execution, au sens du decret d application de la loi MOP (n°93-1268 du 29 novembre 1993) : elaboration des documents a l usage du chantier. Le resultat de cette etude donne generalement lieu a un VISA du maître d oeuvre.');
INSERT INTO l_statut VALUES ('TVX', 'TRAVAUX', 'Resultat des missions de direction de l execution des travaux, d ordonnancement, de coordination et de pilotage ; ainsi que les operations prealables a la reception des travaux, au sens du decret d application de la loi MOP (n°93-1268 du 29 novembre 1993) : inclus la realisation des minutes de chantier et peut inclure un pre-recolement');
INSERT INTO l_statut VALUES ('REC', 'RECOLEMENT', 'Resultat de la mission d assistance a la reception des travaux, au sens du decret d application de la loi MOP (n°93-1268 du 29 novembre 1993) : inclus le recolement des ouvrages et la realisation du Dossier des Ouvrages Executes');
