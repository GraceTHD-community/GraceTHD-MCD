...
CREATE TABLE t_tranchee(	tr_id INTEGER  ,
	...
	tr_fildtec BOOLEAN  ,
	tr_gest_vo VARCHAR(20) NOT NULL REFERENCES t_organisme (or_code),
	tr_pro_voi VARCHAR(20) NOT NULL REFERENCES t_organisme (or_code),
	tr_dategc DATE  ,
	tr_mut BOOLEAN  ,
...
CREATE TABLE t_fourreau(	fx_id INTEGER  ,
	...
	fx_aiguill Date  ,
	fx_mandri Date  ,
	fx_prop VARCHAR(20) NOT NULL REFERENCES t_organisme (or_code),
	fx_gest VARCHAR(20) NOT NULL REFERENCES t_organisme (or_code),
...
CREATE TABLE t_masque(	mq_id INTEGER NOT NULL ,
	mq_pt_code VARCHAR(254)  REFERENCES t_ptech (pt_code),
...
CREATE TABLE t_cable(	cb_id INTEGER  ,
	...
	cb_fabric VARCHAR(254)  REFERENCES t_organisme (or_code),
	cb_ref VARCHAR(254)  ,
	cb_nbfo INTEGER  ,
	cb_fo_util INTEGER  ,
	cb_fo_disp INTEGER  ,
	cb_prop VARCHAR(254) NOT NULL REFERENCES t_organisme (or_code),
	cb_gest VARCHAR(254) NOT NULL REFERENCES t_organisme (or_code),
...
CREATE TABLE t_love(	lo_id INTEGER NOT NULL ,
	...
	lo_no_code INTEGER NOT NULL REFERENCES t_noeud (no_code),
	lo_long INTEGER  ,
	lo_creadat DATE  ,
	lo_majdate DATE  ,
...
CREATE TABLE t_noeud(	no_id INTEGER  ,
	--geom --geometry(Point,2154) NOT NULL ,
	no_code VARCHAR(254) NOT NULL ,
	no_codeext VARCHAR(254)  ,
	no_nom VARCHAR(254)  ,
	no_r1_code VARCHAR(100)  ,
	no_r2_code VARCHAR(100)  ,
	no_r3_code VARCHAR(100)  ,
	no_r4_code VARCHAR(100)  ,
	no_voie VARCHAR(254)  ,
	...
	no_dateins DATE  ,
	no_pro VARCHAR(20) NOT NULL REFERENCES t_organisme (or_code),
	no_gest VARCHAR(20) NOT NULL REFERENCES t_organisme (or_code),
	no_user VARCHAR(254)  REFERENCES t_organisme (or_code),
...
CONSTRAINT "t_noeud_pk" PRIMARY KEY (no_id));	
...
CREATE TABLE t_ebp(	bp_id INTEGER  ,
	...
	bp_dateins DATE  ,
	bp_prop VARCHAR(20) NOT NULL REFERENCES t_organisme (or_code),
...
CREATE TABLE t_sitetech(	st_id INTEGER  ,
	...
	st_prop VARCHAR(20) NOT NULL REFERENCES t_organisme (or_code),
	st_gest VARCHAR(20) NOT NULL REFERENCES t_organisme (or_code),
	st_dt_ms DATE  ,
...
CREATE TABLE t_ltech(	lt_id INTEGER NOT NULL ,
	...
	lt_prop VARCHAR(20) NOT NULL REFERENCES t_organisme (or_code),
	lt_gest VARCHAR(20) NOT NULL REFERENCES t_organisme (or_code),
	lt_dt_ms DATE  ,
...
CREATE TABLE t_siteemission(	se_id INTEGER NOT NULL ,
	...
	se_no_code VARCHAR(50)  REFERENCES t_noeud (no_code),
...
CREATE TABLE t_zone(	zo_id INTEGER  ,
	--geom MultiPolygon  ,
	zo_no_code VARCHAR(254) NOT NULL REFERENCES t_noeud (no_code),
...
CREATE TABLE t_organisme(	or_code VARCHAR (20)  ,
	or_siren VARCHAR(9)  ,
