...
<qgis version="2.14.16-Essen" minimumScale="0" maximumScale="10000" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueRelation" name="bp_typephy">
      <widgetv2config OrderByValue="1" AllowNull="1" FilterExpression="" UseCompleter="0" fieldEditable="1" Key="code" Layer="l_bp_type_phy20160112184742116" Value="code" labelOnTop="0" AllowMulti="0"/>
    </edittype>
    ...
    <edittype widgetv2type="ValueRelation" name="bp_racco">
      <widgetv2config OrderByValue="0" AllowNull="1" FilterExpression="" UseCompleter="0" fieldEditable="1" Key="code" Layer="l_bp_type_log20160112184742109" Value="code" labelOnTop="0" AllowMulti="0"/>
    </edittype>
    ...
    <edittype widgetv2type="ValueRelation" name="sf_zp_code">
      <widgetv2config OrderByValue="0" AllowNull="1" FilterExpression="" UseCompleter="0" fieldEditable="1" Key="zp_code" Layer="t_zpbo_copier20160113010100788" Value="zp_code" labelOnTop="0" AllowMulti="0"/>
    </edittype>
    ...
    <edittype widgetv2type="ValueRelation" name="sf_type">
      <widgetv2config OrderByValue="0" AllowNull="0" FilterExpression="" UseCompleter="0" fieldEditable="1" Key="code" Layer="l_suf_type20160112184742394" Value="code" labelOnTop="0" AllowMulti="0"/>
    </edittype>
    ...
    <edittype widgetv2type="ValueRelation" name="sf_racco">
      <widgetv2config OrderByValue="0" AllowNull="1" FilterExpression="" UseCompleter="0" fieldEditable="1" Key="code" Layer="l_suf_racco20160112184742387" Value="code" labelOnTop="0" AllowMulti="0"/>
    </edittype>
  ...
  <attributeEditorForm>
    <attributeEditorContainer name="Général">
      ...
      <attributeEditorContainer name="Relations">
        <attributeEditorField index="49" name="nd_code"/>
        <attributeEditorField index="32" name="sf_nd_code"/>
        <attributeEditorField index="31" name="sf_code"/>
    ...
    <attributeEditorContainer name="SUF (V)">
      <attributeEditorField index="0" name="bp_code"/>
      <attributeEditorField index="1" name="bp_etiquet"/>
      <attributeEditorField index="2" name="bp_codeext"/>
      <attributeEditorContainer name="Général SF">
        <attributeEditorField index="31" name="sf_code"/>
        <attributeEditorField index="32" name="sf_nd_code"/>
        <attributeEditorField index="33" name="sf_ad_code"/>
        <attributeEditorField index="34" name="sf_zp_code"/>
        <attributeEditorField index="35" name="sf_escal"/>
        <attributeEditorField index="36" name="sf_etage"/>
        <attributeEditorField index="37" name="sf_oper"/>
        <attributeEditorField index="38" name="sf_type"/>
        <attributeEditorField index="39" name="sf_prop"/>
        <attributeEditorField index="40" name="sf_resid"/>
        <attributeEditorField index="41" name="sf_local"/>
        <attributeEditorField index="42" name="sf_racco"/>
      </attributeEditorContainer>
      <attributeEditorContainer name="Traçabilité SF">
        <attributeEditorField index="43" name="sf_comment"/>
        <attributeEditorField index="44" name="sf_creadat"/>
        <attributeEditorField index="45" name="sf_majdate"/>
        <attributeEditorField index="46" name="sf_majsrc"/>
        <attributeEditorField index="47" name="sf_abddate"/>
        <attributeEditorField index="48" name="sf_abdsrc"/>
      </attributeEditorContainer>
    </attributeEditorContainer>
    <attributeEditorContainer name="Noeud (V)">
      ...
      <attributeEditorContainer name="Général ND">
        <attributeEditorField index="49" name="nd_code"/>
        <attributeEditorField index="50" name="nd_codeext"/>
        <attributeEditorField index="51" name="nd_nom"/>
        <attributeEditorField index="52" name="nd_coderat"/>
        <attributeEditorField index="53" name="nd_r1_code"/>
        <attributeEditorField index="54" name="nd_r2_code"/>
        <attributeEditorField index="55" name="nd_r3_code"/>
        <attributeEditorField index="56" name="nd_r4_code"/>
        <attributeEditorField index="57" name="nd_voie"/>
        <attributeEditorField index="58" name="nd_type"/>
        <attributeEditorField index="59" name="nd_type_ep"/>
      </attributeEditorContainer>
      <attributeEditorContainer name="Traçabilité ND">
        <attributeEditorField index="60" name="nd_comment"/>
        <attributeEditorField index="61" name="nd_dtclass"/>
        <attributeEditorField index="62" name="nd_geolqlt"/>
        <attributeEditorField index="63" name="nd_geolmod"/>
        <attributeEditorField index="64" name="nd_geolsrc"/>
        <attributeEditorField index="65" name="nd_creadat"/>
        <attributeEditorField index="66" name="nd_majdate"/>
        <attributeEditorField index="67" name="nd_majsrc"/>
        <attributeEditorField index="68" name="nd_abddate"/>
        <attributeEditorField index="69" name="nd_abdsrc"/>
      </attributeEditorContainer>
    </attributeEditorContainer>
  </attributeEditorForm>
  <widgets>
    <widget name="pt_a_dan">
      <config>
        <option key="IsMultiline" value="false"/>
        <option key="UseHtml" value="false"/>
      </config>
    </widget>
    <widget name="pt_a_dtetu">
      <config>
        <option key="allow_null" value="true"/>
        <option key="calendar_popup" value="false"/>
        <option key="display_format" value="yyyy-MM-dd"/>
        <option key="field_format" value="yyyy-MM-dd"/>
      </config>
    </widget>
    <widget name="pt_a_haut">
      <config>
        <option key="IsMultiline" value="false"/>
        <option key="UseHtml" value="false"/>
      </config>
    </widget>
    <widget name="pt_a_passa">
      <config>
        <option key="IsMultiline" value="false"/>
        <option key="UseHtml" value="false"/>
      </config>
    </widget>
    <widget name="pt_a_strat">
      <config>
        <option key="IsMultiline" value="false"/>
        <option key="UseHtml" value="false"/>
      </config>
    </widget>
    <widget name="pt_a_struc">
      <config>
        <option key="IsMultiline" value="false"/>
        <option key="UseHtml" value="false"/>
      </config>
    </widget>
    <widget name="pt_abddate">
      <config>
        <option key="allow_null" value="true"/>
        <option key="calendar_popup" value="false"/>
        <option key="display_format" value="yyyy-MM-dd HH:mm:ss"/>
        <option key="field_format" value="yyyy-MM-dd HH:mm:ss"/>
      </config>
    </widget>
    <widget name="pt_abdsrc">
      <config>
        <option key="IsMultiline" value="false"/>
        <option key="UseHtml" value="false"/>
      </config>
    </widget>
    <widget name="pt_ad_code">
      <config>
        <option key="IsMultiline" value="false"/>
        <option key="UseHtml" value="false"/>
      </config>
    ...
    <widget name="pt_codeext">
      <config>
        <option key="IsMultiline" value="false"/>
        <option key="UseHtml" value="false"/>
      </config>
    </widget>
    <widget name="pt_comment">
      <config>
        <option key="IsMultiline" value="false"/>
        <option key="UseHtml" value="false"/>
      </config>
    </widget>
    <widget name="pt_creadat">
      <config>
        <option key="IsMultiline" value="false"/>
        <option key="UseHtml" value="false"/>
      </config>
    </widget>
    <widget name="pt_dateins">
      <config>
        <option key="allow_null" value="true"/>
        <option key="calendar_popup" value="false"/>
        <option key="display_format" value="yyyy-MM-dd"/>
    ...
    <widget name="pt_gest_do">
      <config>
        <option key="IsMultiline" value="false"/>
        <option key="UseHtml" value="false"/>
      </config>
    </widget>
    <widget name="pt_majdate">
      <config>
        <option key="allow_null" value="true"/>
        <option key="calendar_popup" value="false"/>
        <option key="display_format" value="yyyy-MM-dd HH:mm:ss"/>
    ...
    <widget name="pt_majsrc">
      <config>
        <option key="IsMultiline" value="false"/>
        <option key="UseHtml" value="false"/>
      </config>
    </widget>
    <widget name="pt_nature">
      <config>
        <option key="IsMultiline" value="false"/>
        <option key="UseHtml" value="false"/>
      </config>
    </widget>
    <widget name="pt_nd_code">
      <config>
        <option key="IsMultiline" value="false"/>
        <option key="UseHtml" value="false"/>
      </config>
    ...
    <widget name="pt_prop_do">
      <config>
        <option key="IsMultiline" value="false"/>
        <option key="UseHtml" value="false"/>
      </config>
    </widget>
    <widget name="pt_proptyp">
      <config>
        <option key="IsMultiline" value="false"/>
        <option key="UseHtml" value="false"/>
      </config>
    </widget>
    <widget name="pt_rf_code">
      <config>
        <option key="IsMultiline" value="false"/>
        <option key="UseHtml" value="false"/>
      </config>
    </widget>
    <widget name="pt_rotatio">
      <config>
        <option key="IsMultiline" value="false"/>
        <option key="UseHtml" value="false"/>
      </config>
    ...
    <widget name="pt_statut">
      <config>
        <option key="IsMultiline" value="false"/>
        <option key="UseHtml" value="false"/>
      </config>
    </widget>
    <widget name="pt_typelog">
      <config>
        <option key="IsMultiline" value="false"/>
        <option key="UseHtml" value="false"/>
      </config>
    </widget>
    <widget name="pt_typephy">
      <config>
        <option key="IsMultiline" value="false"/>
        <option key="UseHtml" value="false"/>
      </config>
    ...
    <widget name="t_cassette20160112184902959_cs_bp_code_BPE__vs_elem_bp_pt_nd__BPE___copier20170810192315220_bp_code">
      <config/>
    </widget>
