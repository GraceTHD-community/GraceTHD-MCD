...
<qgis version="2.8.4-Wien" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="st_typephy" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="BAT" label="Bâtiment"/>
      <category render="true" symbol="1" value="SHE" label="Shelter"/>
      <category render="true" symbol="2" value="ADR" label="Armoire de rue"/>
      <category render="true" symbol="3" value="COF" label="Coffret"/>
    </categories>
    <symbols>
