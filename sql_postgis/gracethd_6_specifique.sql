...
/*Exemple : un prototype de table d'emprises (polygons) qui peuvent être mise en relation avec un noeud afin de stocker par exemple l'emprise d'une chambre ou d'un site par exemple*/
/*
